...
# AWS with assumed role and optional session name (for CloudTrail / stable DB user ARNs)
...
- `--assume-role-session-name`: AWS STS `RoleSessionName` when using `--assume-role` (optional)

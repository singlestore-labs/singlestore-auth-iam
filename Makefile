...
install-python: install-go
	...
	sudo apt install -y python3 python3-pip python3-venv \
		...
		python3-google-auth-oauthlib python3-flake8 black
...
lint-python:
	...
	cd python && python3 -m flake8 --max-line-length=120 --extend-ignore=E203,W503,F841,F541 src/ tests/ || echo "flake8 not available, skipping"
	cd python && python3 -m black --check src/ tests/ || echo "black not available, skipping"
